...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --quiet \
  --set-env-vars "^|^GCP_PROJECT=${GCP_PROJECT}|GCP_ZONE=${GCP_ZONE}|GCE_NAME=${GCE_NAME}|GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID}|ALLOWED_GOOGLE_EMAILS=${ALLOWED_GOOGLE_EMAILS}|ALLOWED_GOOGLE_DOMAINS=${ALLOWED_GOOGLE_DOMAINS}|ALLOWED_ORIGINS=${ALLOWED_ORIGINS}|DUCKDNS_DOMAINS=${DUCKDNS_DOMAINS:-}|VM_NOVNC_PORT=8083|VM_SUNSHINE_PORT=47990|MACHINE_TYPE=${MACHINE_TYPE}|GPU_TYPE=${GPU_TYPE}|GPU_COUNT=${GPU_COUNT}|BOOT_DISK_SIZE=${BOOT_DISK_SIZE}|BOOT_DISK_TYPE=${BOOT_DISK_TYPE}|VM_TAGS=${TAGS}|VM_IMAGE_FAMILY=${VM_IMAGE_FAMILY}|VM_IMAGE_PROJECT=${VM_IMAGE_PROJECT}|VM_NETWORK=${VM_NETWORK}|VM_SUBNET=${VM_SUBNET}|VM_SERVICE_ACCOUNT_EMAIL=${VM_SERVICE_ACCOUNT_EMAIL}|GDRIVE_FOLDER_ID=${GDRIVE_FOLDER_ID}|GDRIVE_STATE_ROOT=${GDRIVE_STATE_ROOT}|GDRIVE_OAUTH_TOKEN_SECRET_NAME=${GDRIVE_OAUTH_TOKEN_SECRET_NAME}|GDRIVE_SERVICE_ACCOUNT_SECRET_NAME=${GDRIVE_SERVICE_ACCOUNT_SECRET_NAME}|VM_STARTUP_SCRIPT_B64=${VM_STARTUP_SCRIPT_B64}|VM_SHUTDOWN_SCRIPT_B64=${VM_SHUTDOWN_SCRIPT_B64}|VM_PERSIST_SCRIPT_B64=${VM_PERSIST_SCRIPT_B64}|VM_STEAM_ENV_B64=${VM_STEAM_ENV_B64}" \
