...
class ApplicationInventoryContractTests(unittest.TestCase):
    ...
    def test_full_steam_bootstrap_is_create_only_and_noninteractive(self):
        ...
        self.assertIn('$steam_home_dir/.config/autostart/Steam.desktop', startup_script)
        self.assertIn('Hidden=true', startup_script)
        self.assertIn('X-GNOME-Autostart-enabled=false', startup_script)
